...
export default async function ProductPageNew({ params, searchParams }: Props) {
  ...
  while (topFacts.length < 5 && product.tags.length > topFacts.length) {
    const nextTag = product.tags[topFacts.length]
    if (nextTag.confidence > 0.25) {
                ...
                <>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 pt-6 border-t border-neutral-200">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm text-neutral-600">
                        {tagsMap.get('issue_no_breakouts')?.confidence > 0.3 && (
                          <li>✓ {Math.round((tagsMap.get('issue_no_breakouts')?.confidence || 0) * 100)}% report no breakouts</li>
                        )}
                        {tagsMap.get('skin_type_sensitive')?.confidence > 0.3 && (
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="border-t border-neutral-200 pt-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Link
                  href={`/products?skinType=${comment.skinType || 'all'}`}
                  className="border border-neutral-200 rounded-lg p-4 hover:bg-neutral-50 transition-colors"
                >
